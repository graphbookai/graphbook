            ...
            while not self.stop_event.is_set():
                ...
                if current_size > self.last_position:
                    ...
                    if self.latest_metadata and 'graph' in self.latest_metadata:
                        self.viewer.set_state("graph_state", self.latest_metadata['graph'])
...
class LogDirectoryReader(TaskLoop):
    ...
    def initialize_files(self):
        ...
        if not self.log_dir.exists():
            ...
            raise ValueError("Directory chosen is not a directory. Will fail to read logs.")
    ...
    def get_output(self, graph_id: str, step_id: str, pin_id: str, index: int) -> Optional[Any]:
...
# Create a more convenient factory function
def create_logger(name: Optional[str] = None, log_dir: str = "logs") -> Logger:
    """
    Create a new logger.
